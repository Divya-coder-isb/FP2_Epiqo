...
Original file is located at
    https://colab.research.google.com/drive/1WtM6TO5gNCYr4tng3hoziyRSTZ9-zAxw
"""
    ...
    if selected_date:
        ...
        # LSTM prediction if selected date is 3 months or more from today
            ...
            try:
                ...
                # Prepare data for LSTM prediction (dummy data used here, replace with actual)
                lstm_input = np.zeros((1, 60, 1))  # Replace with actual data
        ...
        try:
            # Prepare data for SVM prediction (dummy data used here, replace with actual)
            svm_input = np.zeros((1, 8))  # Replace with actual data
