...
if is_weekend(selected_date):
    ...
    if col1.button("Apply"):
        if selected_date >= datetime.today() + timedelta(days=90):  # Long term (greater than or equal to 3 months)
        ...
        elif selected_date < datetime.today() + timedelta(days=90):  # Short term (less than 3 months)
